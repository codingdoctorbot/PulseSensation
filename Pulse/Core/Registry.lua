...
local CATEGORY_ORDER = {
    "COMBAT", "ENVIRONMENT", "HEALTH", "FLIGHT", "MOVEMENT", "WORLD",
    "ALERT_STATE", "ALERT_DEVICE", "ALERT_SOCIAL", "ALERT_CC",
    "ALERT_UNIT_WATCH", "ALERT_THREAT", "ALERT_WORLD", "ALERT_SELF_CAST",
    "CONTROLLER_UI", "GAMEPAD_INTERACT",
}
...
Pulse.Triggers = {
    ...
    { id = "jumped", category = "MOVEMENT", mode = "TAP", default = false,
      label = "Jumped",
    ...
    { id = "swimTexture", category = "MOVEMENT", continuous = true, default = false,
      ...
      devTuning = true,
      tunables = {
          { key = "separateMotors", label = "Own motor", default = true, boolean = true,
          ...
          { key = "peak", label = "Effort peak", default = 0.10, min = 0.0, max = 0.5, step = 0.01,
          ...
          { key = "strokeRateMin", label = "Stroke rate, slow (Hz)", default = 0.45, min = 0.1, max = 2.0, step = 0.05,
            desc = "Strokes per second at barely-moving speed." },
          { key = "strokeRateMax", label = "Stroke rate, fast (Hz)", default = 0.95, min = 0.1, max = 3.0, step = 0.05,
          ...
          { key = "strokeDepth", label = "Stroke depth", default = 0.55, min = 0.0, max = 1.0, step = 0.05,
            desc = "How pronounced each stroke is against its own baseline. 0 is a flat drag with no rhythm at all." },
          { key = "strokeAsymmetry", label = "Pull / glide balance", default = 0.35, min = 0.0, max = 0.5, step = 0.05,
    ...
    { id = "waterTexture", category = "MOVEMENT", continuous = true, default = false,
      label = "In water",
      ...
      devTuning = true,
      tunables = {
          { key = "baseline", label = "Water presence", default = 0.04, min = 0.0, max = 0.30, step = 0.01,
          ...
          { key = "waveRate", label = "Swell rate (Hz)", default = 0.15, min = 0.02, max = 1.0, step = 0.01,
          ...
          { key = "waveDepth", label = "Swell depth", default = 0.0, min = 0.0, max = 1.0, step = 0.05,
          ...
          { key = "submergedBoost", label = "Underwater boost", default = 1.5, min = 1.0, max = 3.0, step = 0.1,
    ...
    { id = "taxiRide", category = "MOVEMENT", continuous = true, default = false,
      ...
      devTuning = true,
      tunables = {
          { key = "windAmplitude",    label = "Wind amplitude",       default = 0.1,  min = 0.0, max = 0.5, step = 0.02,
            desc = "Only audible if \"Riding a flight path\" is also enabled on its own tab." },
          { key = "waveCycleSeconds", label = "Wave cycle (seconds)", default = 1.75, min = 0.5, max = 4.0, step = 0.25,
            desc = "How fast the wingbeat-style undulation cycles." },
      } },
    { id = "formChanged", category = "MOVEMENT", mode = "CHIME", default = false,
    ...
    { id = "mountUp", category = "FLIGHT", mode = "KNOCK", default = true,
      label = "Mounted up",
      desc  = "Two solid hits when you mount." },
    { id = "dismount", category = "FLIGHT", mode = "TAP", default = false,
      label = "Dismounted",
    ...
    { id = "glideThrust", category = "FLIGHT", continuous = true, default = true,
      ...
      tunables = {
          ...
          { key = "thrillPeak",    label = "Thrill peak (high)",   default = 0.7,  min = 0.0, max = 1.0, step = 0.05,
            desc = "High-motor ceiling at full gliding speed. Only audible while actually gliding." },
          { key = "thrillCurve",   label = "Thrill curve (high)",  default = 2.0,  min = 1.0, max = 4.0, step = 0.5,
    ...
    { id = "castTexture", category = "COMBAT", continuous = true, default = false,
      ...
      tunables = {
          ...
          { key = "castPresence", label = "Cast presence (low)", default = 0.1, min = 0.0, max = 0.5, step = 0.01,
          ...
          { key = "castSwellPeak", label = "Cast swell peak (high)", default = 0.7, min = 0.0, max = 1.0, step = 0.05,
          ...
          { key = "channelHum",    label = "Channel hum (high)",     default = 0.2, min = 0.0, max = 1.0, step = 0.05,
    ...
    { id = "craftTexture", category = "COMBAT", continuous = true, default = false,
      ...
      tunables = {
          { key = "bedGain", label = "Bed strength", default = 1.0, min = 0.0, max = 2.0, step = 0.05,
          ...
          { key = "strikeGain", label = "Strike strength", default = 1.0, min = 0.0, max = 2.0, step = 0.05,
    ...
    { id = "deflect", category = "COMBAT", mode = "DEFLECT", default = true,
      label = "You parried, dodged, or blocked",
      desc  = "A very short, sharp tick when you avoid an incoming attack." },
    { id = "honorGained", category = "COMBAT", mode = "CHIME", throttle = 0.5, default = false,
      label = "Honor gained",
    ...
    { id = "factionGained", category = "COMBAT", mode = "CHIME", throttle = 0.5, default = false,
    ...
    { id = "comboPoint", category = "COMBAT", mode = "TICK", default = false,
    ...
    { id = "damageTaken", category = "COMBAT", mode = "TICK", throttle = 0.2, default = false,
    ...
    { id = "healReceived", category = "COMBAT", mode = "TICK", throttle = 0.2, default = false,
      defaultIntensity = 0.3,
    ...
    { id = "autoRepeatStop", category = "COMBAT", mode = "TAP", default = false,
    ...
    { id = "meleeAttackStart", category = "COMBAT", mode = "TAP", default = false,
    ...
    { id = "meleeAttackStop", category = "COMBAT", mode = "TAP", default = false,
    ...
    { id = "autoShotFired", category = "COMBAT", mode = "TICK", default = false,
      label = "Auto Shot fired",
      desc  = "A very light tick on every Auto Shot arrow, timed to the real shot, not estimated.",
    ...
    { id = "weaponSwingMain", category = "COMBAT", mode = "TICK", default = false,
      label = "Weapon swing (main hand)",
      desc  = "A light tick estimated to land with each main-hand weapon swing.",
      tunables = {
          { key = "forceEstimator", label = "Use the old estimator", default = false, boolean = true,
          ...
          { key = "parryHasteEnabled", label = "Apply parry haste", default = 1, boolean = true,
    ...
    { id = "weaponSwingOff", category = "COMBAT", mode = "DEFLECT", default = false,
    ...
    { id = "resourceCapped", category = "COMBAT", mode = "HEAVY", throttle = 2.0, default = false,
      label = "Secondary resource full", desc = "Fires when your class's secondary resource fills up — combo points, holy power, soul shards, chi, arcane charges, essence or runes, whichever your specialisation uses.",
      events = { "UNIT_POWER_UPDATE" }, unit = "player",
    ...
    { id = "bossAbilityWarning", category = "COMBAT", mode = "RISING", default = false,
      ...
      tunables = {
          { key = "warningLead", label = "Warning lead time", min = 0.5, max = 5.0, step = 0.5,
            default = 2.0, desc = "How many seconds before the scripted moment this fires." },
          { key = "minSeverity", label = "Minimum severity", min = 1, max = 3, step = 1,
            default = 2, desc = "1 = every scripted event, 3 = only the most severe. Higher means rarer, more significant warnings." },
      },
    ...
    { id = "bossChatWarning", category = "COMBAT", mode = "TAP", throttle = 1.0, default = false,
    ...
    { id = "breathWarning", category = "ENVIRONMENT", mode = "PULSE_BEAT", default = true,
      label = "Low on breath",
    ...
    { id = "breathTexture", category = "ENVIRONMENT", continuous = true, default = false,
      ...
      devTuning = true,
      tunables = {
          { key = "gaspPeak",        label = "Gasp peak",           default = 0.6, min = 0.0, max = 1.0, step = 0.05,
          ...
          { key = "heartRateCalm",     label = "Heart rate (calm), BPM",     default = 30, min = 20, max = 80, step = 5,
          ...
          { key = "heartRateCritical", label = "Heart rate (critical), BPM", default = 100, min = 60, max = 180, step = 5,
          ...
          { key = "dangerStartThreshold", label = "Danger start threshold", default = 0.70, min = 0.4, max = 0.85, step = 0.025,
          ...
          { key = "midBreathThreshold", label = "Mid breath threshold", default = 0.40, min = 0.2, max = 0.6, step = 0.025,
          ...
          { key = "lateBreathThreshold", label = "Late breath threshold", default = 0.15, min = 0.05, max = 0.3, step = 0.025,
    ...
    { id = "lootGold", category = "WORLD", mode = "TICK", default = false,
      label = "Gold looted",
    ...
    { id = "equipChanged", category = "WORLD", mode = "TICK", default = false,
    ...
    { id = "lowHealthWarning", category = "HEALTH", default = false,
      label = "Low health",
      ...
      tunables = {
          { key = "heartRate", label = "Heart rate (BPM)", min = 50, max = 140,
            step = 1, default = 56,
          ...
          { key = "distinctiveness", label = "Distinctiveness", min = 0, max = 1.0, step = 0.05,
            default = 0.7,
    ...
    { id = "selfCastSent", category = "ALERT_SELF_CAST", mode = "TAP", throttle = 0.2, default = false,
      label = "Cast sent",
      desc = "Fires the instant you press a cast, before the server has confirmed it.",
      events = { "UNIT_SPELLCAST_SENT" }, unit = "player",
    ...
    { id = "selfCastStart", category = "ALERT_SELF_CAST", mode = "TAP", throttle = 0.2, default = false,
      label = "Your cast started", desc = "Fires when one of your own casts begins.",
      events = { "UNIT_SPELLCAST_START" }, unit = "player" },
    { id = "selfCastStop", category = "ALERT_SELF_CAST", mode = "TAP", throttle = 0.2, default = false,
      label = "Your cast ended", desc = "Fires when one of your own casts ends, whether or not it completed.",
      events = { "UNIT_SPELLCAST_STOP" }, unit = "player" },
    { id = "selfCastInterrupted", category = "ALERT_SELF_CAST", mode = "STUTTER", throttle = 0.5, default = true,
      label = "Your cast interrupted", desc = "Fires when one of your own casts is interrupted or cancelled before completion.",
      events = { "UNIT_SPELLCAST_INTERRUPTED" }, unit = "player",
    ...
    { id = "selfCastFailed", category = "ALERT_SELF_CAST", mode = "TAP", throttle = 0.4, default = false,
      label = "Your cast failed", desc = "Fires when a cast of yours is rejected outright — out of range, not facing the target, still on cooldown.",
      events = { "UNIT_SPELLCAST_FAILED", "UNIT_SPELLCAST_FAILED_QUIET" }, unit = "player",
    ...
    -- rejected cast.
    { id = "actionFailed", category = "ALERT_SELF_CAST", mode = "TAP", throttle = 0.5, default = false,
      label = "Action failed", desc = "Fires when the game refuses an action — out of range, facing the wrong way, not enough resource, still on cooldown.",
      events = { "UI_ERROR_MESSAGE" }, unit = nil,
      caveat = "One pattern for every kind of refusal. May also do nothing inside dungeons and raids." },
    { id = "selfChannelStart", category = "ALERT_SELF_CAST", mode = "TAP", throttle = 0.2, default = false,
      label = "Your channel started", desc = "Fires when you begin channelling a spell.",
      events = { "UNIT_SPELLCAST_CHANNEL_START" }, unit = "player" },
    { id = "selfChannelStop", category = "ALERT_SELF_CAST", mode = "TAP", throttle = 0.2, default = false,
      label = "Your channel ended", desc = "Fires when a channelled spell of yours ends, whether it ran to completion or was cut short.",
      events = { "UNIT_SPELLCAST_CHANNEL_STOP" }, unit = "player" },
    ...
    -- completed case.
    { id = "selfChannelInterrupted", category = "ALERT_SELF_CAST", mode = "THUD", default = false,
    ...
    { id = "selfEmpowerStage", category = "ALERT_SELF_CAST", mode = "TAP", throttle = 0.15, default = false,
      label = "Empowered cast stage", desc = "Fires as an empowered cast of yours begins and ends.",
      events = { "UNIT_SPELLCAST_EMPOWER_START", "UNIT_SPELLCAST_EMPOWER_STOP" }, unit = "player",
    ...
    { id = "selfCastSucceeded", category = "ALERT_SELF_CAST", mode = "CHIME", throttle = 0.2, default = false,
      label = "Your cast succeeded", desc = "Fires when one of your own casts completes successfully — distinct from a cast simply ending.",
      events = { "UNIT_SPELLCAST_SUCCEEDED" }, unit = "player",
    ...
    { id = "ccMaster", category = "ALERT_CC", mode = "DOUBLE_TAP", throttle = 0.3, default = true,
      ...
      events = { "LOSS_OF_CONTROL_ADDED", "LOSS_OF_CONTROL_UPDATE" }, unit = nil,
    ...
    { id = "ccStun", category = "ALERT_CC", mode = "HEAVY", throttle = 0.3, default = true,
      label = "Stunned", desc = "Fires when you are stunned (STUN, STUN_MECHANIC).",
      events = { "LOSS_OF_CONTROL_ADDED", "LOSS_OF_CONTROL_UPDATE" }, unit = nil },
    { id = "ccFear", category = "ALERT_CC", mode = "STUTTER", throttle = 0.3, default = true,
      label = "Feared or charmed", desc = "Fires when you are feared or charmed (FEAR, FEAR_MECHANIC, CHARM).",
      events = { "LOSS_OF_CONTROL_ADDED", "LOSS_OF_CONTROL_UPDATE" }, unit = nil },
    { id = "ccSilence", category = "ALERT_CC", mode = "RISING", throttle = 0.3, default = true,
      label = "Silenced", desc = "Fires when you are silenced (SILENCE).",
      events = { "LOSS_OF_CONTROL_ADDED", "LOSS_OF_CONTROL_UPDATE" }, unit = nil },
    { id = "ccRoot", category = "ALERT_CC", mode = "LONG", throttle = 0.3, default = true,
      label = "Rooted", desc = "Fires when you are rooted in place (ROOT). You can still act, so this is a rung below the cues that stop you entirely.",
      events = { "LOSS_OF_CONTROL_ADDED", "LOSS_OF_CONTROL_UPDATE" }, unit = nil },
    { id = "ccDisarm", category = "ALERT_CC", mode = "DOUBLE_TAP", throttle = 0.3, default = false,
      label = "Disarmed", desc = "Fires when you are disarmed (DISARM).",
      events = { "LOSS_OF_CONTROL_ADDED", "LOSS_OF_CONTROL_UPDATE" }, unit = nil },
    { id = "ccPacify", category = "ALERT_CC", mode = "DOUBLE_TAP", throttle = 0.3, default = false,
      label = "Pacified or school-locked", desc = "Fires when you are pacified or a spell school is locked out (PACIFY, PACIFYSILENCE, SCHOOL_INTERRUPT).",
      events = { "LOSS_OF_CONTROL_ADDED", "LOSS_OF_CONTROL_UPDATE" }, unit = nil,
    ...
    { id = "ccConfuse", category = "ALERT_CC", mode = "STUTTER", throttle = 0.3, default = true,
      label = "Confused or possessed", desc = "Fires when you are confused or possessed (CONFUSE, POSSESS).",
      events = { "LOSS_OF_CONTROL_ADDED", "LOSS_OF_CONTROL_UPDATE" }, unit = nil },

    -- ── Accessibility: Threat ───────────────────────────────────────────────────
    { id = "threatRising", category = "ALERT_THREAT", mode = "RISING", throttle = 1.0, default = true,
      label = "Threat rising", desc = "Fires when your threat on your target rises to high-but-not-tanking (status 1).",
      events = { "UNIT_THREAT_SITUATION_UPDATE" }, unit = "player",
    ...
    { id = "threatAggro", category = "ALERT_THREAT", mode = "HEAVY", throttle = 1.0, default = true,
      label = "You have aggro", desc = "Fires when you take over threat on your target (status 2 or 3).",
      events = { "UNIT_THREAT_SITUATION_UPDATE" }, unit = "player",
      caveat = "Shares the social-pull limitation of the threat-rising cue." },
    { id = "threatLost", category = "ALERT_THREAT", mode = "LONG", throttle = 1.0, default = false,
      label = "Threat lost", desc = "Fires when you drop off the top of your target's threat table.",
      events = { "UNIT_THREAT_SITUATION_UPDATE" }, unit = "player",
    ...
    { id = "targetCastStart", category = "ALERT_UNIT_WATCH", mode = "DOUBLE_TAP", throttle = 0.35, default = true,
      label = "Target started casting", desc = "Fires when your current target begins casting. The cue is the occurrence only — which spell it is cannot be read.",
      events = { "UNIT_SPELLCAST_START" }, unit = "target",
      caveat = "Also fires when you switch to a target that is already mid-cast." },
    { id = "targetChannelStart", category = "ALERT_UNIT_WATCH", mode = "DOUBLE_TAP", throttle = 0.35, default = true,
      label = "Target started channelling", desc = "Fires when your current target begins channelling.",
      events = { "UNIT_SPELLCAST_CHANNEL_START" }, unit = "target" },
    { id = "focusCastStart", category = "ALERT_UNIT_WATCH", mode = "DOUBLE_TAP", throttle = 0.35, default = false,
      label = "Focus started casting", desc = "Fires when your focus target begins casting.",
      events = { "UNIT_SPELLCAST_START" }, unit = "focus",
      caveat = "Shares its pulse pattern with the target cue. If your focus is also your target, you get one cue rather than two." },
    { id = "focusChannelStart", category = "ALERT_UNIT_WATCH", mode = "DOUBLE_TAP", throttle = 0.35, default = false,
      label = "Focus started channelling", desc = "Fires when your focus target begins channelling.",
      events = { "UNIT_SPELLCAST_CHANNEL_START" }, unit = "focus" },
    -- Moved out of the removed ALERT_EXPERIMENTAL category 2026-09-16, grouped with the
    -- other target-cast cues above.
    { id = "targetCastStopped", category = "ALERT_UNIT_WATCH", mode = "DOUBLE_TAP", throttle = 0.5, default = false,
      label = "Target's cast stopped", desc = "Fires when your target's spellcast stops before it finishes.",
      events = { "UNIT_SPELLCAST_INTERRUPTED" }, unit = "target",
    ...
    { id = "targetChanged", category = "ALERT_UNIT_WATCH", mode = "TAP", throttle = 0.15, default = false,
      label = "Target changed", desc = "Fires when you change target, including when you clear it.",
      events = { "PLAYER_TARGET_CHANGED" }, unit = nil },
    { id = "focusChanged", category = "ALERT_UNIT_WATCH", mode = "TAP", throttle = 0.15, default = false,
      label = "Focus changed", desc = "Fires when you set or clear your focus target.",
      events = { "PLAYER_FOCUS_CHANGED" }, unit = nil },

    -- ── Accessibility: Combat and life state (fully generic) ───────────────────
    { id = "combatEnter", category = "ALERT_STATE", mode = "LONG", throttle = 1.0, default = true,
      label = "Entering combat", desc = "Fires when you enter combat.",
      events = { "PLAYER_REGEN_DISABLED" }, unit = nil },
    { id = "combatLeave", category = "ALERT_STATE", mode = "TAP", throttle = 1.0, default = false,
      label = "Leaving combat", desc = "Fires when you drop out of combat.",
      events = { "PLAYER_REGEN_ENABLED" }, unit = nil },
    { id = "playerDead", category = "ALERT_STATE", mode = "HEAVY", throttle = 2.0, default = true,
      label = "You died", desc = "Fires when you die.",
      events = { "PLAYER_DEAD" }, unit = nil },
    { id = "playerAlive", category = "ALERT_STATE", mode = "DOUBLE_TAP", throttle = 2.0, default = false,
      label = "You are alive again", desc = "Fires when you are resurrected or leave ghost form.",
      events = { "PLAYER_ALIVE", "PLAYER_UNGHOST" }, unit = nil,
      caveat = "PLAYER_ALIVE also fires when you release to a graveyard, so this can fire while you are still a ghost." },
    { id = "resurrectRequest", category = "ALERT_STATE", mode = "DOUBLE_TAP", throttle = 1.0, default = true,
      label = "Resurrection offered", desc = "Fires when someone offers you a resurrection and the accept dialog appears.",
      events = { "RESURRECT_REQUEST" }, unit = nil },
    { id = "encounterStart", category = "ALERT_STATE", mode = "RISING", throttle = 2.0, default = false,
      label = "Boss encounter started", desc = "Fires when a boss encounter begins.",
      events = { "ENCOUNTER_START" }, unit = nil },
    { id = "encounterEnd", category = "ALERT_STATE", mode = "LONG", throttle = 2.0, default = false,
      label = "Boss encounter ended", desc = "Fires when a boss encounter ends, in victory or in a wipe.",
      events = { "ENCOUNTER_END" }, unit = nil },
    { id = "vehicleEnter", category = "ALERT_STATE", mode = "LONG", throttle = 1.0, default = false,
      label = "Entered a vehicle", desc = "Fires when you enter a vehicle and your action bar is replaced.",
      events = { "UNIT_ENTERED_VEHICLE" }, unit = "player" },
    { id = "vehicleExit", category = "ALERT_STATE", mode = "LONG", throttle = 1.0, default = false,
      label = "Left a vehicle", desc = "Fires when you leave a vehicle and your own action bar returns.",
      events = { "UNIT_EXITED_VEHICLE" }, unit = "player" },

    -- ── Accessibility: Group and social (generic except bgQueue) ───────────────
    { id = "readyCheck", category = "ALERT_SOCIAL", mode = "DOUBLE_TAP", throttle = 1.0, default = true,
      label = "Ready check", desc = "Fires when a ready check starts.",
      events = { "READY_CHECK" }, unit = nil },
    { id = "readyCheckDone", category = "ALERT_SOCIAL", mode = "TAP", throttle = 1.0, default = false,
      label = "Ready check finished", desc = "Fires when a ready check completes or times out.",
      events = { "READY_CHECK_FINISHED" }, unit = nil },
    { id = "rolePoll", category = "ALERT_SOCIAL", mode = "DOUBLE_TAP", throttle = 1.0, default = false,
      label = "Role poll", desc = "Fires when a role check starts.",
      events = { "ROLE_POLL_BEGIN" }, unit = nil },
    { id = "queuePop", category = "ALERT_SOCIAL", mode = "DOUBLE_TAP", throttle = 1.0, default = true,
      label = "Dungeon queue popped", desc = "Fires when a dungeon or raid finder queue pops and the accept dialog appears.",
      events = { "LFG_PROPOSAL_SHOW" }, unit = nil },
    { id = "bgQueue", category = "ALERT_SOCIAL", mode = "DOUBLE_TAP", throttle = 2.0, default = true,
      label = "Battleground queue ready", desc = "Fires when a battleground or arena queue is ready to enter.",
      events = { "UPDATE_BATTLEFIELD_STATUS" }, unit = nil,
      caveat = "Fires only when a queue enters the ready-to-enter state, not on every status update." },
    { id = "partyInvite", category = "ALERT_SOCIAL", mode = "DOUBLE_TAP", throttle = 1.0, default = false,
      label = "Party invite", desc = "Fires when someone invites you to a group.",
      events = { "PARTY_INVITE_REQUEST" }, unit = nil },
    { id = "guildInvite", category = "ALERT_SOCIAL", mode = "DOUBLE_TAP", throttle = 1.0, default = false,
      label = "Guild invite", desc = "Fires when someone invites you to a guild.",
      events = { "GUILD_INVITE_REQUEST" }, unit = nil },
    { id = "duelRequest", category = "ALERT_SOCIAL", mode = "DOUBLE_TAP", throttle = 1.0, default = false,
      label = "Duel request", desc = "Fires when someone challenges you to a duel.",
      events = { "DUEL_REQUESTED" }, unit = nil },
    { id = "tradeRequest", category = "ALERT_SOCIAL", mode = "DOUBLE_TAP", throttle = 1.0, default = false,
      label = "Trade opened", desc = "Fires when a trade window opens.",
      events = { "TRADE_SHOW" }, unit = nil },
    { id = "summonRequest", category = "ALERT_SOCIAL", mode = "DOUBLE_TAP", throttle = 1.0, default = false,
      label = "Summon offered", desc = "Fires when someone summons you and the accept dialog appears.",
      events = { "CONFIRM_SUMMON" }, unit = nil,
      caveat = "Fires for any summon confirmation dialog, not only a player summoning you." },
    { id = "groupRoster", category = "ALERT_SOCIAL", mode = "TAP", throttle = 2.0, default = false,
      label = "Group roster changed", desc = "Fires when someone joins or leaves your group.",
      events = { "GROUP_ROSTER_UPDATE" }, unit = nil,
      caveat = "Noisy. In a raid this event fires very frequently. Kept for completeness and defaulted off." },
    { id = "partyLeader", category = "ALERT_SOCIAL", mode = "TAP", throttle = 2.0, default = false,
      label = "Party leader changed", desc = "Fires when group leadership changes hands.",
      events = { "PARTY_LEADER_CHANGED" }, unit = nil },
    { id = "raidTarget", category = "ALERT_SOCIAL", mode = "TAP", throttle = 1.0, default = false,
      label = "Raid marker changed", desc = "Fires when raid target markers are set or cleared.",
      events = { "RAID_TARGET_UPDATE" }, unit = nil },
    { id = "whisper", category = "ALERT_SOCIAL", mode = "DOUBLE_TAP", throttle = 1.0, default = false,
      label = "Whisper received", desc = "Fires when you receive a whisper.",
      events = { "CHAT_MSG_WHISPER" }, unit = nil },
    { id = "bnWhisper", category = "ALERT_SOCIAL", mode = "DOUBLE_TAP", throttle = 1.0, default = false,
      label = "Battle.net whisper received", desc = "Fires when you receive a Battle.net whisper.",
      events = { "CHAT_MSG_BN_WHISPER" }, unit = nil },

    -- ── Accessibility: World and interface (generic except afkToggle) ──────────
    { id = "uiInfoMessage", category = "ALERT_WORLD", mode = "TAP", throttle = 0.5, default = false,
      label = "Interface message", desc = "Fires on the yellow informational messages the game shows in the top centre of the screen.",
      events = { "UI_INFO_MESSAGE" }, unit = nil },
    { id = "lootOpened", category = "ALERT_WORLD", mode = "TAP", throttle = 0.5, default = false,
      label = "Loot window opened", desc = "Fires when a loot window opens.",
      events = { "LOOT_OPENED" }, unit = nil },
    { id = "lootRoll", category = "ALERT_WORLD", mode = "DOUBLE_TAP", throttle = 0.5, default = false,
      label = "Loot roll started", desc = "Fires when a group loot roll opens and the roll buttons appear.",
      events = { "START_LOOT_ROLL" }, unit = nil },
    { id = "lootConfirm", category = "ALERT_WORLD", mode = "DOUBLE_TAP", throttle = 0.5, default = false,
      label = "Loot roll confirmation", desc = "Fires when the game asks you to confirm a loot roll.",
      events = { "CONFIRM_LOOT_ROLL" }, unit = nil },
    { id = "lootReceived", category = "ALERT_WORLD", mode = "TAP", throttle = 0.5, default = false,
      label = "Loot received", desc = "Fires when loot is awarded to you.",
      events = { "CHAT_MSG_LOOT" }, unit = nil,
    ...
    { id = "merchantShow", category = "ALERT_WORLD", mode = "TAP", throttle = 1.0, default = false,
      label = "Vendor window opened", desc = "Fires when a vendor window opens.",
      events = { "MERCHANT_SHOW" }, unit = nil },
    ...
    { id = "guildBankOpened", category = "ALERT_WORLD", mode = "DOUBLE_TAP", throttle = 1.0, default = false,
      ...
      events = { "GUILDBANKFRAME_OPENED" }, unit = nil },
    { id = "auctionHouseShow", category = "ALERT_WORLD", mode = "CHIME", throttle = 1.0, default = false,
      label = "Auction house opened", desc = "A chime when the auction house opens.",
      caveat = "Untested.",
      events = { "AUCTION_HOUSE_SHOW" }, unit = nil },
    { id = "stableShow", category = "ALERT_WORLD", mode = "TAP", throttle = 1.0, default = false,
      label = "Stable opened", desc = "Fires when the stable master's window opens.",
      caveat = "Untested.",
      events = { "PET_STABLE_SHOW" }, unit = nil },
    { id = "binderShow", category = "ALERT_WORLD", mode = "TAP", throttle = 1.0, default = false,
      label = "Innkeeper hearth prompt", desc = "Fires when an innkeeper asks to make this your home.",
      caveat = "Untested.",
      events = { "CONFIRM_BINDER" }, unit = nil },
    { id = "spiritHealerShow", category = "ALERT_WORLD", mode = "LONG", throttle = 1.0, default = false,
      label = "Spirit healer", desc = "One long, sombre pulse when a spirit healer's window opens.",
      ...
      unit = nil },
    { id = "gossipShow", category = "ALERT_WORLD", mode = "TICK", throttle = 1.0, default = false,
      label = "Talking to someone", desc = "The lightest possible tick when a conversation window opens with any NPC.",
      ...
      events = { "GOSSIP_SHOW" }, unit = nil },
    { id = "itemTextBegin", category = "ALERT_WORLD", mode = "TICK", throttle = 1.0, default = false,
      label = "Reading something", desc = "A tick when a book, plaque, gravestone or signpost opens to be read.",
      caveat = "Pure flavour — nothing depends on it. Untested.",
      events = { "ITEM_TEXT_BEGIN" }, unit = nil },
    { id = "interactionWindow", category = "ALERT_WORLD", mode = "TAP", throttle = 1.0, default = false,
      label = "Any other window", desc = "A tap when an NPC or world object opens a window nothing else here covers.",
      ...
      unit = nil },
    { id = "interactionWindowClosed", category = "ALERT_WORLD", mode = "TICK", throttle = 1.0, default = false,
      label = "Interaction window closed", desc = "A light tick when you step away from an NPC or close its window.",
      caveat = "Fires for every interaction window, including the ones with their own opening cue. Untested.",
      unit = nil },
    { id = "mailShow", category = "ALERT_WORLD", mode = "TAP", throttle = 1.0, default = false,
      label = "Mailbox opened", desc = "Fires when the mailbox opens.",
      events = { "MAIL_SHOW" }, unit = nil },
    { id = "bankOpened", category = "ALERT_WORLD", mode = "TAP", throttle = 1.0, default = false,
      label = "Bank opened", desc = "Fires when the bank window opens.",
      events = { "BANKFRAME_OPENED" }, unit = nil },
    { id = "taxiOpened", category = "ALERT_WORLD", mode = "TAP", throttle = 1.0, default = false,
      label = "Flight map opened", desc = "Fires when a flight master's map opens.",
      events = { "TAXIMAP_OPENED" }, unit = nil },
    { id = "questDetail", category = "ALERT_WORLD", mode = "TAP", throttle = 0.5, default = false,
      label = "Quest offered", desc = "Fires when a quest's detail page opens, ready to accept.",
      events = { "QUEST_DETAIL" }, unit = nil },
    { id = "questAccepted", category = "ALERT_WORLD", mode = "TAP", throttle = 0.5, default = false,
      label = "Quest accepted", desc = "Fires when you accept a quest.",
      events = { "QUEST_ACCEPTED" }, unit = nil },
    { id = "questComplete", category = "ALERT_WORLD", mode = "DOUBLE_TAP", throttle = 0.5, default = false,
      label = "Quest ready to hand in", desc = "Fires when a quest's completion page opens, ready to hand in.",
      events = { "QUEST_COMPLETE" }, unit = nil },
    { id = "questTurnedIn", category = "ALERT_WORLD", mode = "DOUBLE_TAP", throttle = 0.5, default = false,
      label = "Quest turned in", desc = "Fires when a quest is handed in and its reward is taken.",
      events = { "QUEST_TURNED_IN" }, unit = nil },
    { id = "zoneChanged", category = "ALERT_WORLD", mode = "TAP", throttle = 2.0, default = false,
      label = "Zone changed", desc = "Fires when you enter a new zone.",
      events = { "ZONE_CHANGED_NEW_AREA" }, unit = nil },
    { id = "enteringWorld", category = "ALERT_WORLD", mode = "TAP", throttle = 5.0, default = false,
      label = "Loading screen finished", desc = "Fires when a loading screen ends and the world is back.",
      events = { "PLAYER_ENTERING_WORLD" }, unit = nil },
    { id = "levelUp", category = "ALERT_WORLD", mode = "DOUBLE_TAP", throttle = 2.0, default = true,
      label = "Level up", desc = "Fires when you gain a level.",
      events = { "PLAYER_LEVEL_UP" }, unit = nil },
    { id = "achievement", category = "ALERT_WORLD", mode = "DOUBLE_TAP", throttle = 2.0, default = false,
      label = "Achievement earned", desc = "Fires when you earn an achievement.",
      events = { "ACHIEVEMENT_EARNED" }, unit = nil },
    { id = "afkToggle", category = "ALERT_WORLD", mode = "TAP", throttle = 1.0, default = false,
      label = "AFK or DND toggled", desc = "Fires when your own away or do-not-disturb flag actually changes.",
      events = { "PLAYER_FLAGS_CHANGED" }, unit = "player",
    ...
    { id = "trainerShow", category = "ALERT_WORLD", mode = "TAP", throttle = 1.0, default = false,
      defaultIntensity = 0.6,
      label = "Trainer window opened", desc = "Fires when a class or profession trainer's window opens.",
      events = { "TRAINER_SHOW" }, unit = nil,
    ...
    { id = "tradeSkillShow", category = "ALERT_WORLD", mode = "TAP", throttle = 1.0, default = false,
      defaultIntensity = 0.6,
      label = "Profession window opened", desc = "Fires when a profession or crafting window opens.",
      events = { "TRADE_SKILL_SHOW" }, unit = nil },
    { id = "spellLearned", category = "ALERT_WORLD", mode = "CHIME", throttle = 0.5, default = false,
      defaultIntensity = 0.8,
      label = "Learned a new spell", desc = "A bright tick when you learn a new ability.",
      events = { "LEARNED_SPELL_IN_SKILL_LINE" }, unit = nil,
    ...
    { id = "skillUp", category = "ALERT_WORLD", mode = "TICK", throttle = 0.5, default = false,
      defaultIntensity = 0.5,
      label = "Profession skill increased", desc = "A light tick when a profession or weapon skill goes up a point.",
      events = { "CHAT_MSG_SKILL" }, unit = nil,
    ...
    { id = "recipeLearned", category = "ALERT_WORLD", mode = "CHIME", throttle = 0.5, default = false,
      defaultIntensity = 0.8,
      label = "Learned a new recipe", desc = "A bright tick when you learn a new recipe or pattern.",
      events = { "NEW_RECIPE_LEARNED" }, unit = nil,
    ...
    { id = "padBattery", category = "ALERT_DEVICE", mode = "DOUBLE_TAP", throttle = 60, default = true,
      label = "Controller battery low", desc = "Fires once when the controller's battery drops into its low or critical range.",
      events = { "GAME_PAD_POWER_CHANGED" }, unit = nil,
      caveat = "Fires on the crossing into low, not repeatedly while low." },
    { id = "padConnected", category = "ALERT_DEVICE", mode = "DOUBLE_TAP", throttle = 2.0, default = false,
      label = "Controller connected", desc = "Fires when a controller connects.",
      events = { "GAME_PAD_CONNECTED" }, unit = nil },
    { id = "padDisconnected", category = "ALERT_DEVICE", mode = nil, throttle = 0, default = true,
      label = "Controller disconnected", desc = "Clears any vibration still in flight when the controller disconnects.",
      events = { "GAME_PAD_DISCONNECTED" }, unit = nil,
    ...
    { id = "uiNavigate", category = "CONTROLLER_UI", mode = "TICK", throttle = 0.03, default = false,
    ...
    { id = "uiNavigateEdge", category = "CONTROLLER_UI", mode = "DEFLECT", throttle = 0.1, default = false,
      defaultIntensity = 0.5,
    ...
    { id = "uiSelectionDisabled", category = "CONTROLLER_UI", mode = "DOUBLE_TAP", throttle = 0.2, default = false,
      defaultIntensity = 0.5,
    ...
    -- ── Controller UI: focus ────────────────────────────────────────────────────
    { id = "uiFocusIn", category = "CONTROLLER_UI", mode = "TAP", throttle = 0.2, default = false,
      defaultIntensity = 0.5,
    ...
    { id = "uiFocusOut", category = "CONTROLLER_UI", mode = "TICK", throttle = 0.2, default = false,
      defaultIntensity = 0.5,
    ...
    { id = "uiTabChanged", category = "CONTROLLER_UI", mode = "DEFLECT", throttle = 0.15, default = false,
      defaultIntensity = 0.6,
    ...
    { id = "radialOpen", category = "CONTROLLER_UI", mode = "TAP", throttle = 0.2, default = false,
      defaultIntensity = 0.6,
    ...
    { id = "radialClose", category = "CONTROLLER_UI", mode = "TICK", throttle = 0.2, default = false,
      defaultIntensity = 0.5,
    ...
    { id = "radialTick", category = "CONTROLLER_UI", mode = "TICK", throttle = 0.03, default = false,
      defaultIntensity = 0.3,
    ...
    { id = "radialBlocked", category = "CONTROLLER_UI", mode = "DEFLECT", throttle = 0.15, default = false,
      defaultIntensity = 0.6,
    ...
    { id = "radialSelect", category = "CONTROLLER_UI", mode = "CHIME", throttle = 0.2, default = false,
    ...
    { id = "radialCancel", category = "CONTROLLER_UI", mode = "TAP", throttle = 0.2, default = false,
      defaultIntensity = 0.5,
    ...
    { id = "radialPage", category = "CONTROLLER_UI", mode = "DOUBLE_TAP", throttle = 0.15, default = false,
      defaultIntensity = 0.5,
    ...
    { id = "softEnemyChanged", category = "GAMEPAD_INTERACT", mode = "TICK", throttle = 0.1, default = false,
      defaultIntensity = 0.3,
    ...
    { id = "softFriendChanged", category = "GAMEPAD_INTERACT", mode = "TICK", throttle = 0.1, default = false,
      defaultIntensity = 0.3,
    ...
    { id = "softInteractChanged", category = "GAMEPAD_INTERACT", mode = "TAP", throttle = 0.1, default = false,
    ...
    { id = "cursorPickup", category = "GAMEPAD_INTERACT", mode = "TAP", throttle = 0.1, default = false,
      defaultIntensity = 0.6,
    ...
    { id = "cursorDrop", category = "GAMEPAD_INTERACT", mode = "TAP", throttle = 0.1, default = false,
      defaultIntensity = 0.5,
    ...
    { id = "actionBarPage", category = "GAMEPAD_INTERACT", mode = "DOUBLE_TAP", throttle = 0.15, default = false,
      defaultIntensity = 0.5,
    ...
    { id = "inputModeChanged", category = "GAMEPAD_INTERACT", mode = "CHIME", throttle = 1.0, default = false,
      defaultIntensity = 0.7,
    ...
    -- default and UNFELT.
    { id = "craftStart", category = "ALERT_SELF_CAST", mode = "CHIME", throttle = 0.3, default = false,
      defaultIntensity = 0.6,
      label = "Craft started",
    ...
    { id = "craftComplete", category = "ALERT_SELF_CAST", mode = "CHIME", throttle = 0.3, default = false,
    ...
    { id = "craftStopped", category = "ALERT_SELF_CAST", mode = "DEFLECT", throttle = 0.3, default = false,
      defaultIntensity = 0.7,
    ...
    { id = "selfCastInstant", category = "ALERT_SELF_CAST", mode = "CLICK", throttle = 0.1, default = false,
      defaultIntensity = 0.5,
    ...
    { id = "debuffReceived", category = "COMBAT", mode = "CRACK", throttle = 0.4, default = false,
      defaultIntensity = 0.6,
    ...
    { id = "stealthTexture", category = "MOVEMENT", continuous = true, default = false,
      ...
      devTuning = true,
      tunables = {
          { key = "baseline", label = "Stealth baseline", default = 0.06, min = 0.0, max = 0.30, step = 0.01,
          ...
          { key = "breathRate", label = "Breath rate (Hz)", default = 0.30, min = 0.05, max = 2.0, step = 0.05,
            desc = "How often the hum swells, in cycles per second. 0.30 is roughly one slow breath every three seconds." },
          { key = "breathDepth", label = "Breath depth", default = 0.35, min = 0.0, max = 1.0, step = 0.05,
    ...
    { id = "locomotion", category = "MOVEMENT", continuous = true, default = false,
      ...
      devTuning = true,
      tunables = {
          { key = "mountedOnly", label = "Only while mounted", default = true, boolean = true,
          ...
          { key = "splitFeet", label = "Split left and right", default = true, boolean = true,
          ...
          { key = "gaitIntensity", label = "Gait strength", default = 0.35, min = 0.0, max = 1.0, step = 0.05,
            desc = "Overall strength of each footfall before speed and state scaling." },
          { key = "runCadence", label = "Run cadence (steps/s)", default = 2.8, min = 0.5, max = 6.0, step = 0.1,
            desc = "Steps per second at full running speed. Scaled by how fast you are actually moving." },
          { key = "walkCadence", label = "Walk cadence (steps/s)", default = 1.8, min = 0.5, max = 4.0, step = 0.1,
            desc = "Steps per second at normal walking speed." },
          { key = "mountIntensity", label = "Mount weight", default = 1.2, min = 0.0, max = 2.0, step = 0.05,
    ...
    { id = "popupShown", category = "CONTROLLER_UI", mode = "TAP", throttle = 0.3, default = false,
      defaultIntensity = 0.7,
    ...
    { id = "popupHidden", category = "CONTROLLER_UI", mode = "CLICK", throttle = 0.3, default = false,
      defaultIntensity = 0.5,
...
local PAGE_LAYOUT = {
    { id = "COMBAT", label = "Combat", sections = {
        { label = "Offensive", cues = {
            "abilityPulse", "meleeAttackStart", "meleeAttackStop",
            "autoRepeatStart", "autoRepeatStop", "autoShotFired",
            "weaponSwingMain", "weaponSwingOff" } },
        { label = "Defensive", cues = {
            "critLanded", "damageTaken", "deflect", "healCrit", "healReceived",
            "debuffReceived" } },
        { label = "Resources", cues = { "comboPoint", "resourceCapped", "cooldownReady" } },
        { label = "Rewards", cues = { "honorGained", "factionGained" } },
        { label = "Encounter", cues = {
            "encounterStart", "encounterEnd", "bossAbilityWarning", "bossChatWarning" } },
    } },
    ...
    { id = "CASTING", label = "Casting", sections = {
        { label = "Casting texture", cues = { "castTexture", "craftTexture" } },
        { label = "Cast outcomes", cues = {
            "selfCastSucceeded", "selfCastInstant", "selfCastInterrupted", "selfCastFailed",
        ...
        { label = "Lifecycle (advanced)", cues = {
            "selfCastSent", "selfCastStart", "selfCastStop",
            "selfChannelStart", "selfChannelStop" } },
    } },

    { id = "MOVEMENT", label = "Movement & Travel", sections = {
        { label = "Movement", cues = {
            "landingSoft", "landingHard", "jumped", "waterTexture", "swimTexture",
            "formChanged", "locomotion", "stealthTexture" } },
        { label = "Mounts & travel", cues = {
            "mountUp", "dismount", "glideThrust", "taxiRide", "vehicleEnter", "vehicleExit" } },
    } },

    { id = "CHARACTER", label = "Character & Status", sections = {
        { label = "Life & combat state", cues = {
            "combatEnter", "combatLeave", "playerDead", "playerAlive", "resurrectRequest" } },
        { label = "Health & survival", cues = {
            "lowHealthWarning", "lowHealthTexture", "breathWarning", "breathTexture" } },
    ...
    { id = "CONTROL", label = "Control & Threat", sections = {
        { label = "Loss of control", cues = {
            "ccStun", "ccFear", "ccSilence", "ccRoot", "ccDisarm", "ccPacify", "ccConfuse" } },
        { label = "Threat", cues = { "threatRising", "threatAggro", "threatLost" } },
    } },

    { id = "TARGET", label = "Target & Focus", sections = {
        { label = "Target", cues = {
            "targetCastStart", "targetChannelStart", "targetCastStopped", "targetChanged" } },
        { label = "Focus", cues = {
            "focusCastStart", "focusChannelStart", "focusChanged" } },
    } },

    { id = "WORLD", label = "World & Environment", sections = {
        { label = "Environment", cues = { "weatherChanged" } },
        { label = "World", cues = {
            "zoneChanged", "enteringWorld", "emote", "npcEmote" } },
        { label = "Loot", cues = {
            "lootGold", "itemObtained", "lootOpened", "lootRoll", "lootConfirm", "lootReceived" } },
        { label = "Quests", cues = {
            "questDetail", "questAccepted", "questComplete", "questTurnedIn" } },
        { label = "Progression", cues = {
            "levelUp", "xpGained", "achievement", "spellLearned", "recipeLearned",
            "skillUp" } },
    } },

    { id = "SOCIAL", label = "Social & Group", sections = {
        { label = "Group readiness", cues = {
            "readyCheck", "readyCheckDone", "rolePoll", "queuePop", "bgQueue" } },
        { label = "Group changes", cues = { "groupRoster", "partyLeader", "raidTarget" } },
        { label = "Invites & requests", cues = {
            "partyInvite", "guildInvite", "duelRequest", "tradeRequest", "summonRequest" } },
        { label = "Messages", cues = { "whisper", "bnWhisper" } },
    } },

    { id = "INTERFACE", label = "Interface & Accessibility", sections = {
        ...
        { label = "Windows", cues = {
            "merchantShow", "mailShow", "bankOpened", "guildBankOpened", "taxiOpened",
            "trainerShow", "tradeSkillShow", "auctionHouseShow", "stableShow",
            "binderShow", "spiritHealerShow" } },
    ...
    { id = "CONTROLLER", label = "Controller", sections = {
    ...
    { id = "CONTROLLER_UI", label = "Controller UI", sections = {
        ...
        { label = "Radial menu", cues = {
            "radialOpen", "radialPage", "radialTick", "radialBlocked",
            "radialSelect", "radialCancel", "radialClose" } },
    } },
    ...
    { id = "GAMEPAD_INTERACT", label = "Gamepad Controller Interactions", sections = {
        { label = "Targeting", cues = {
            "softInteractChanged", "softEnemyChanged", "softFriendChanged" } },
...
for _, trigger in ipairs(Pulse.Triggers) do
    if not placed[trigger.id] and not isCategoryMaster[trigger.id] then
        print(("Pulse: cue %q has no settings page — add it to PAGE_LAYOUT (Core/Registry.lua)")
            :format(trigger.id))
    end
end

function Registry:GetTrigger(id) return byID[id] end
function Registry:GetTriggersByCategory(category) return byCategory[category] or {} end
...
function Registry:GetPages() return PAGE_LAYOUT end

function Registry:GetCategories()
    local result = {}
    for _, category in ipairs(CATEGORY_ORDER) do
        if categoriesInUse[category] then result[#result + 1] = category end
    end
    return result
end
