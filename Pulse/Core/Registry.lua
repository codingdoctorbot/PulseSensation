...
Pulse.Triggers = {
    ...
    },
    {
        ...
        desc = "Fires when a cast of yours is rejected outright — out of range, not facing the target, still on cooldown.",
    ...
    -- rejected cast.
    {
        ...
        default = false,
        label = "Action failed",
        desc = "Fires when the game refuses an action — out of range, facing the wrong way, not enough resource, still on cooldown.",
    ...
    },
    {
        ...
        default = true,
        label = "Level up",
        desc = "Fires when you gain a level.",
    ...
    },
    {
        ...
        desc = "Fires when you earn an achievement.",
